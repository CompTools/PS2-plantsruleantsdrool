...
# this script is compiled just for answering question 1 of problem-set2 (https://github.com/CompTools/PS2-plantsruleantsdrool) for class zoo6927

######################Important:please read following before executing the script###############################
#Please make sure the data file "flights.May2017-Apr2018.csv" is under folder "data"
